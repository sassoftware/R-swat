...
`SW_CASConnection` = function(hostname, port, username, password, soptions, error, .copy = FALSE)
{
  ...
  ans <- new("_p_CASConnection", ref=ans) ;
...
`SW_CASConnection_upload` = function(self, file_name, params)
{
  ...
  ans <- new("_p_CASResponse", ref=ans) ;
...
`SW_CASRequest_getParameters` = function(self)
{
  ...
  ans <- new("_p_CASValueList", ref=ans) ;
...
{
  accessorFuns = list('destroy' = SW_CASValueList_destroy, 'getTypeName' = SW_CASValueList_getTypeName, 'getSOptions' = SW_CASValueList_getSOptions, 'isNULL' = SW_CASValueList_isNULL, 'setNil' = SW_CASValueList_setNil, 'setInt32' = SW_CASValueList_setInt32, 'setInt64' = SW_CASValueList_setInt64, 'setDate' = SW_CASValueList_setDate, 'setTime' = SW_CASValueList_setTime, 'setDateTime' = SW_CASValueList_setDateTime, 'setDouble' = SW_CASValueList_setDouble, 'setString' = SW_CASValueList_setString, 'setBoolean' = SW_CASValueList_setBoolean, 'createListAt' = SW_CASValueList_createListAt, 'getItem' = SW_CASValueList_getItem, 'getLastErrorMessage' = SW_CASValueList_getLastErrorMessage, 'getNItems' = SW_CASValueList_getNItems);
  ;        idx = pmatch(name, names(accessorFuns));
  if(is.na(idx)) 
  return(callNextMethod(x, name));
  f = accessorFuns[[idx]];
...
`SW_CASFormatter` = function(soptions, error, .copy = FALSE)
{
  ...
  ans <- new("_p_CASFormatter", ref=ans) ;
...
`SW_CASConnectionEventWatcher` = function(length, timeout, soptions, error, .copy = FALSE)
{
  ...
  ans <- new("_p_CASConnectionEventWatcher", ref=ans) ;
...
`SW_CASDataBuffer` = function(reclen, nrecs, soptions, error, .copy = FALSE)
{
  ...
  ans <- new("_p_CASDataBuffer", ref=ans) ;
...
{
  accessorFuns = list('destroy' = SW_CASDataBuffer_destroy, 'getTypeName' = SW_CASDataBuffer_getTypeName, 'getSOptions' = SW_CASDataBuffer_getSOptions, 'setString' = SW_CASDataBuffer_setString, 'setBinary' = SW_CASDataBuffer_setBinary, 'setDouble' = SW_CASDataBuffer_setDouble, 'setInt32' = SW_CASDataBuffer_setInt32, 'setInt64' = SW_CASDataBuffer_setInt64, 'send' = SW_CASDataBuffer_send, 'getLastErrorMessage' = SW_CASDataBuffer_getLastErrorMessage);
  ;        idx = pmatch(name, names(accessorFuns));
  if(is.na(idx)) 
  return(callNextMethod(x, name));
  f = accessorFuns[[idx]];
