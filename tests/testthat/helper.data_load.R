...
n1_1 <- c(2, 3, 5, NA, 5, 598)
n2_1 <- c(5, 6, 7, 7, NA, 120)
n3_1 <- c(12, 13, 15, 15, 13, 198)
n4_1 <- c(NA, 16, 17, 15, 8, 1120)
n5_1 <- c(1.2, 1.3, 1.5, 1.5, 0.8, NA)
s_1 <- c("aa", "bb", "cc", "dd", "dd", "dd")
s0_1 <- c("aa", "bb", "cc", "dd", "dd", " ")
d_1 <- c("12/31/09", "09/08/78", "12/25/00", "04/01/16", NA, "03/08/02")
d_1 <- as.Date(d, "%m/%d/%y")
df0_1 <- data.frame(n1_1, n2_1, n3_1, n4_1, s_1, d_1)
