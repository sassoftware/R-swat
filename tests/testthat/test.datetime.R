...
test_that("test.r2cas", {
  expect_equal(
    rPOSIXlt2cas(as.POSIXlt(strptime("1970-01-01 12:00:00",
      "%Y-%m-%d %H:%M:%S",
      tz = "UTC"
    ))),
    315662400000000
  ...
  expect_equal(
    rPOSIXct2cas(as.POSIXct(strptime("1970-01-01 12:00:00",
      "%Y-%m-%d %H:%M:%S",
      tz = "UTC"
    ))),
    315662400000000
...
test_that("test.r2sas", {
  expect_equal(
    rPOSIXlt2sas(as.POSIXlt(strptime("1970-01-01 12:00:00",
      "%Y-%m-%d %H:%M:%S",
      tz = "UTC"
    ))),
    315662400
  ...
  expect_equal(
    rPOSIXct2sas(as.POSIXct(strptime("1970-01-01 12:00:00",
      "%Y-%m-%d %H:%M:%S",
      tz = "UTC"
    ))),
    315662400
